...
{
      //加载网页
//      NSString *encodeUrl = [message stringByAddingPercentEscapesUsingEncoding:NSUTF8StringEncoding];
      [_webView loadRequest:[NSURLRequest requestWithURL:[NSURL URLWithString:message]]];
      ...
      [_webView stringByEvaluatingJavaScriptFromString:webViewBridgeScriptContent];
      //////////////////////////////////////////////////////////////////////////////
      
      if (_injectedJavaScript != nil) {
            NSString *jsEvaluationValue = [_webView stringByEvaluatingJavaScriptFromString:_injectedJavaScript];
      ...
      else if (_onLoadingFinish && !_webView.loading && ![_webView.request.URL.absoluteString isEqualToString:@"about:blank"]) {
